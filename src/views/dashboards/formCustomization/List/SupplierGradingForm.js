...
const initialRows = [
  ...
  {
    id: 4,
    field: 'Rate quality perception (1-10)',
    roles: { User: 'N', AE: 'Y', PM: 'Y', ME: 'Y', QE: 'Y', BDM: 'Y', Admin: 'Y', Supplier: 'N' }
  },
  {
    id: 5,
    field: 'Did the supplier confirm ship date within 1 business day',
    roles: { User: 'N', AE: 'Y', PM: 'Y', ME: 'Y', QE: 'Y', BDM: 'Y', Admin: 'Y', Supplier: 'N' }
  },
  {
    id: 6,
    field: 'Were project issues addressed clearly and timely',
    roles: { User: 'N', AE: 'Y', PM: 'Y', ME: 'Y', QE: 'Y', BDM: 'Y', Admin: 'Y', Supplier: 'N' }
  },
  {
    id: 7,
    field: "Rate PM's experience with supplier (1-10)",
    roles: { User: 'N', AE: 'Y', PM: 'Y', ME: 'Y', QE: 'Y', BDM: 'Y', Admin: 'Y', Supplier: 'N' }
  },
  {
    id: 8,
  ...
  {
    id: 15,
    field: 'Was the order ready to ship on the promised date',
    roles: { User: 'N', AE: 'Y', PM: 'Y', ME: 'Y', QE: 'Y', BDM: 'Y', Admin: 'Y', Supplier: 'N' }
  },
  {
    id: 16,
    field: 'Did the supplier notify the PM that the order shipped',
    roles: { User: 'N', AE: 'Y', PM: 'Y', ME: 'Y', QE: 'Y', BDM: 'Y', Admin: 'Y', Supplier: 'N' }
  },
  {
    id: 17,
    field: "Were all PM's questions answered clearly and timely",
    roles: { User: 'N', AE: 'Y', PM: 'Y', ME: 'Y', QE: 'Y', BDM: 'Y', Admin: 'Y', Supplier: 'N' }
  },
  {
    id: 18,
    field: 'Did the supplier follow all WO instructions',
    roles: { User: 'N', AE: 'Y', PM: 'Y', ME: 'Y', QE: 'Y', BDM: 'Y', Admin: 'Y', Supplier: 'N' }
  },
  {
    id: 19,
    field: 'Supplier Score',
    roles: { User: 'N', AE: 'Y', PM: 'Y', ME: 'Y', QE: 'Y', BDM: 'Y', Admin: 'Y', Supplier: 'N' }
  },
  {
    id: 20,
      ...
      >
        <Table
          ...
          sx={{
            ...
            // default cell inner; we'll override first-column inner where needed
            '.cellInner': {
              height: '100%',
              display: 'flex',
              alignItems: 'center',
              ...
              <TableRow key={row.id} hover sx={{ height: BODY_ROW_HEIGHT }}>
                <TableCell
                  sx={{
                    ...
                    backgroundColor: '#fff',
                    zIndex: 1400,
                    padding: '8px 0', // small vertical padding so wrapped text breathes
                    borderRight: `0.5px solid ${BORDER_GREY}`,
                    backgroundClip: 'padding-box'
                  }}
                >
                  {/* First column inner: allow wrapping and left-align */}
                  <div
                    className='cellInner'
                    style={{
